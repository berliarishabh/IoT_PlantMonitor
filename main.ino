...
// These keys are generated when you create a new stream on data.sparkfun.com
...
delay(1000);
    ...
    delay(2000);//stay awake for 20 seconds to allow for App updates
    //Power down between sends to save power, measured in seconds.
    System.sleep(SLEEP_MODE_DEEP, 60);  //for Particle Photon 5 minute
